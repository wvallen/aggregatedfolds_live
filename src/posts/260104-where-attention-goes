---
title: 260104 - Where Attention Goes
date: 2026-01-04
layout: post.njk
tags: post
...
<table>
  <thead>
    <tr>
      <th>Attention mode</th>
      <th>How it usually starts</th>
      <th>What’s happening</th>
      <th>Where it tends to lead</th>
      <th>A small redirect</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Autopilot</td>
      <td>Routine tasks, familiar paths</td>
      <td>Learned patterns run quietly</td>
      <td>Time passes unnoticed</td>
      <td>Pause, name the next deliberate step</td>
    </tr>
    <tr>
      <td>Foraging</td>
      <td>Feeds, links, suggested videos</td>
      <td>Sampling novelty without commitment</td>
      <td>Endless scrolling</td>
      <td>Close the app, save one thing worth keeping</td>
    </tr>
    <tr>
      <td>Threat watch</td>
      <td>News, uncertainty, social stress</td>
      <td>Attention narrows toward risk</td>
      <td>Anxiety loops</td>
      <td>Check once, set a limit, step away</td>
    </tr>
    <tr>
      <td>Emotional capture</td>
      <td>Visually or emotionally charged content</td>
      <td>Attention pulled without asking</td>
      <td>“Why am I watching this?” moments</td>
      <td>Name the feeling, change posture or room</td>
    </tr>
    <tr>
      <td>Learning / naming</td>
      <td>Reading, categorizing</td>
      <td>Experience compressed into concepts</td>
      <td>Abstraction without action</td>
      <td>Note one idea, return to the session</td>
    </tr>
    <tr>
      <td>Imagining / planning</td>
      <td>Thinking ahead, reflecting</td>
      <td>Futures and hypotheses unfold</td>
      <td>Drift or rumination</td>
      <td>Write one sentence or make one choice</td>
    </tr>
    <tr>
      <td>Social simulation</td>
      <td>Remembered moments, imagined reactions</td>
      <td>Replaying past interactions and desired co-created futures</td>
      <td>Self-monitoring loops</td>
      <td>Name the loop, return to a physical task</td>
    </tr>
    <tr>
      <td>Resting integration</td>
      <td>Fatigue, transitions</td>
      <td>Background consolidation</td>
      <td>Avoidance if it lingers</td>
      <td>Do nothing briefly, then re-enter</td>
    </tr>
    <tr>
      <td>Contemplative attention</td>
      <td>Walking, looking, being still</td>
      <td>Attention settles on what is</td>
      <td>Coherence, calm</td>
      <td>Stay</td>
    </tr>
    <tr>
      <td>Scale-shifting attention</td>
      <td>Nature, physics, deep time</td>
      <td>Perspective expands across scales</td>
      <td>Orientation</td>
      <td>Look closer or farther</td>
    </tr>
  </tbody>
</table>
