...
This began as a spatial idea. <a href="https://w.oodland.com/topology.html">Relational topography</a>. The notion that meaning emerges through alignment rather than position alone. Repeated interaction leaves grooves. Shared focus creates surfaces. Certain patterns persist even as the objects moving across them change. Over time, the metaphor hardened into something more operational. A way to describe how attention moves, gathers, and releases.
...
<figure class="figure">
  <img
    src="/images/260208-a-social-attractor.jpeg"
    alt="Low winter light on dry grass; a human shadow cast into the field toward a fixed post."
    loading="lazy"
    decoding="async"
  />
  <figcaption><em>shadow on local topology</em></figcaption>
</figure>
